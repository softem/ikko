...
<table border="1">
	...
	<tr>
		<td>1</td><td>保存ボタン</td><td>プロジェクト名入力エリア</td><td>必須</td><td>入力されていない場合</td><td>プロジェクト名の横に「必須入力です。」と表示する</td>
	</tr>
	<tr>
		<td>2</td><td>保存ボタン</td><td>プロジェクト名入力エリア</td><td>桁数</td><td>入力された文字が40文字を越える場合</td><td>プロジェクト名の横に「40文字以内で入力して下さい。」と表示する</td>
	</tr>
	<tr>
		<td>3</td><td>保存ボタン</td><td>プロジェクト名入力エリア</td><td>重複</td><td>登録・更新時に該当データが存在した場合</td><td>プロジェクト名の横に「すでに登録されています。」と表示する</td>
	</tr>
</table>
