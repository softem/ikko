...
<div id="local-menu">
	<a href="/ikko/individual_business_report/${prev}">前月へ移動</a>
	<a href="${t:url("/individual_business_report")}">当月に戻る</a>
	<a href="/ikko/individual_business_report/${next}">次月へ移動</a>
	<a href="${t:url("/welcome/main")}">メインメニューへ戻る</a>
</div>

<div id="results">
<jsp:include page="individual_business_report_table.jsp"></jsp:include>
</div>
